...
class HttpClient:
    ...
    def _request(
        ...
        try:
            ...
            response = self.session.request(
                method=method, url=url, headers=headers, data=data, timeout=self.timeout
            )
            ...
            return ApiResponse(success=False, code=-1, message=error_msg)
    ...
    def get(
        self, url: str, headers: Dict[str, str], raise_on_error: bool = True
    ) -> ApiResponse:
        """GET请求"""
